...
public class NetworkTrafficSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNetTrafficMode = findPreference(LMOSettings.Secure.NETWORK_TRAFFIC_MODE);
        ...
        mNetTrafficPosition = findPreference(LMOSettings.Secure.NETWORK_TRAFFIC_POSITION);
        ...
        if (disallowCenteredTraffic && position == POSITION_CENTER) {
            ...
            Settings.Secure.putInt(getActivity().getContentResolver(),
                LMOSettings.Secure.NETWORK_TRAFFIC_POSITION, position);
        }
        mNetTrafficPosition.setValue(String.valueOf(position));

        mNetTrafficAutohide = findPreference(LMOSettings.Secure.NETWORK_TRAFFIC_AUTOHIDE);
        mNetTrafficAutohide.setOnPreferenceChangeListener(this);

        mNetTrafficUnits = findPreference(LMOSettings.Secure.NETWORK_TRAFFIC_UNITS);
        ...
        mNetTrafficShowUnits = findPreference(LMOSettings.Secure.NETWORK_TRAFFIC_SHOW_UNITS);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mNetTrafficMode) {
            ...
            Settings.Secure.putInt(getActivity().getContentResolver(),
                    LMOSettings.Secure.NETWORK_TRAFFIC_MODE, mode);
            updateEnabledStates(mode);
            ...
            Settings.Secure.putInt(getActivity().getContentResolver(),
                    LMOSettings.Secure.NETWORK_TRAFFIC_UNITS, units);
            ...
            Settings.Secure.putInt(getActivity().getContentResolver(),
                    LMOSettings.Secure.NETWORK_TRAFFIC_SHOW_UNITS, showUnits);
        }
        return true;
    }
