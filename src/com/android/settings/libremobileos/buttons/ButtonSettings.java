...
public class ButtonSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final int torchLongPressPowerTimeout = Settings.System.getInt(resolver,
                LMOSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT, 0);
        ...
        if (hasMenuKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    LMOSettings.System.KEY_MENU_ACTION, Action.MENU);
        ...
        if (hasAssistKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    LMOSettings.System.KEY_ASSIST_ACTION, Action.SEARCH);
            mAssistPressAction = initList(KEY_ASSIST_PRESS, pressAction);

            Action longPressAction = Action.fromSettings(resolver,
                    LMOSettings.System.KEY_ASSIST_LONG_PRESS_ACTION, Action.VOICE_SEARCH);
        ...
        if (hasAppSwitchKey) {
            ...
            Action pressAction = Action.fromSettings(resolver,
                    LMOSettings.System.KEY_APP_SWITCH_ACTION, Action.APP_SWITCH);
        ...
        if (hasVolumeKeys) {
            ...
            final boolean volumePanelOnLeft = Settings.Secure.getIntForUser(resolver,
                    LMOSettings.Secure.VOLUME_PANEL_ON_LEFT, 0, UserHandle.USER_CURRENT) != 0;
    ...
    public void onResume() {
        ...
        if (mHomeAnswerCall != null) {
            ...
            final boolean homeButtonAnswersCall =
                (incallHomeBehavior == LMOSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mBackLongPressAction ||
            ...
            handleListChange(mTorchLongPressPowerTimeout, newValue,
                    LMOSettings.System.TORCH_LONG_PRESS_POWER_TIMEOUT);
            return true;
            ...
            Settings.System.putInt(getContentResolver(),
                    LMOSettings.System.ENABLE_TASKBAR, ((Boolean) newValue) ? 1 : 0);
            return true;
        }
        return false;
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference == mSwapVolumeButtons) {
            ...
            Settings.System.putInt(requireActivity().getContentResolver(),
                    LMOSettings.System.SWAP_VOLUME_KEYS_ON_ROTATION, value);
    ...
    private void handleToggleHomeButtonAnswersCallPreferenceClick() {
        Settings.Secure.putInt(getContentResolver(),
                LMOSettings.Secure.RING_HOME_BUTTON_BEHAVIOR, (mHomeAnswerCall.isChecked()
                        ? LMOSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_ANSWER
                        : LMOSettings.Secure.RING_HOME_BUTTON_BEHAVIOR_DO_NOTHING));
    }
